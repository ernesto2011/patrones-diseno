...
class LocationIcon implements Location{
    ...
    display(coordinates: { x: number; y: number; }): void {
        console.log(`
            Coords: ${this.type} en ${coordinates.x}, ${coordinates.y}
            con icono %c[${this.iconImage}]
        `, COLORS.green);
    }
}
...
function main(){
    ...
    const locations =[
        ...
        new MapLocation(14,36, factory.getLocationIcon('Hospital')),
        new MapLocation(10,20, factory.getLocationIcon('Escuela')),
        new MapLocation(10,20, factory.getLocationIcon('Oficina')),
        new MapLocation(10,20, factory.getLocationIcon('Hospital')),
        new MapLocation(10,20, factory.getLocationIcon('Hospital')),
        new MapLocation(10,20, factory.getLocationIcon('Escuela')),
        new MapLocation(10,20, factory.getLocationIcon('Hospital')),
